...
//
// Solidity: function mint(address owner, bytes32 rootHash) returns(uint256)
func (_RegStore *RegStoreTransactor) Mint(opts *bind.TransactOpts, owner common.Address, rootHash [32]byte) (*types.Transaction, error) {
	return _RegStore.contract.Transact(opts, "mint", owner, rootHash)
}

// Mint is a paid mutator transaction binding the contract method 0x2cfd3005.
//
// Solidity: function mint(address owner, bytes32 rootHash) returns(uint256)
func (_RegStore *RegStoreSession) Mint(owner common.Address, rootHash [32]byte) (*types.Transaction, error) {
	return _RegStore.Contract.Mint(&_RegStore.TransactOpts, owner, rootHash)
}

// Mint is a paid mutator transaction binding the contract method 0x2cfd3005.
//
// Solidity: function mint(address owner, bytes32 rootHash) returns(uint256)
func (_RegStore *RegStoreTransactorSession) Mint(owner common.Address, rootHash [32]byte) (*types.Transaction, error) {
	return _RegStore.Contract.Mint(&_RegStore.TransactOpts, owner, rootHash)
}
